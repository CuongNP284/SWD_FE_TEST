...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="h-4/5 w-4/5 bg-white-100 relative overflow-hidden rounded-lg">
      <div
        id="signin"
        className={`bg-white-100 absolute top-0 left-0 h-full w-1/2 flex justify-center items-center transition-all duration-700 ease-in-out z-20 ${
